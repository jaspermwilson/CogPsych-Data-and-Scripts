...
studied_words = read.csv("KL_studiedwords.csv", header = TRUE, sep = ",")
subjectfile = read.csv("KL_initial.csv", header = TRUE, sep = ",")
...
write.csv(merged_file, file = "KL_final.csv", row.names = FALSE)
